...
public class SearchDeviceActivity extends MyListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SamplesUtils.indeterminate(SearchDeviceActivity.this, _handler,
				getResources().getString(R.string.scanning), _discoveryWorkder,
	...
	protected void showDevices() {
		...
		if (_devices.size() > 0) {
			...
			list.add(getResources().getString(R.string.none_found));
		...
		_handler.post(new Runnable() {
			public void run() {
				...
				Toast.makeText(getBaseContext(),
						getResources().getString(R.string.select_device),
